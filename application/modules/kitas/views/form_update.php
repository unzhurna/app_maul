<article class="col-sm-7">
	<div class="dark data-block">
		...
		<section>
			<?php echo form_open('kitas/post_update', 'class="form-horizontal"'); ?>
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<?php 
							echo form_dropdown('id_imigran', $opt_imigran, set_value('id_imigran', $id_imigran), 'class="select1"', 'multiple'); 
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
						<?php 
							echo form_input(array('name'=>'masa_berlaku', 'class'=>'form-control datepicker', 'value'=>set_value(format_dmy('masa_berlaku'), format_dmy($masa_berlaku))));
