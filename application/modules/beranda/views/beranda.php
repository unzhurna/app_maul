	...
	<div class="row">
		...
		<div class="col-sm-2 col-xs-6">
			<a class="data-block widget-block" href="<?php echo base_url('dokter');?>">
				<span class="badge"><?php echo $dokter; ?></span>
		...
		<div class="col-sm-2 col-xs-6">
			<a class="data-block widget-block" href="<?php echo base_url('pasien');?>">
				<span class="badge"><?php echo $pasien; ?></span>
				<span class="widget-icon elusive icon-address-book-alt"></span>
				<strong>pasien</strong>
			</a>
		</div>
		<div class="col-sm-2 col-xs-6">
			<a class="data-block widget-block" href="<?php echo base_url('kunjungan');?>">
				<span class="badge"><?php echo $kunjungan; ?></span>
				<span class="widget-icon elusive icon-calendar-sign"></span>
				<strong>Kunjungan</strong>
			</a>
		</div>
		<div class="col-sm-2 col-xs-6">
			<a class="data-block widget-block" href="<?php echo base_url('poliklinik');?>">
				<span class="badge"><?php echo $poliklinik; ?></span>
